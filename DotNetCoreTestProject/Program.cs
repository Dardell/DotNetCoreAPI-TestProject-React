...
builder.Services.AddCors(options =>
{
    options.AddPolicy("CORSPolicy",
        builder =>
        {
            ...
            .AllowAnyMethod()
            .AllowAnyHeader()
            .WithOrigins("http://localhost:3000", "https://appname.azurestaticaps.net");
        });
});
...
app.UseSwaggerUI(SwaggerUIOptions =>
{
    ...
    SwaggerUIOptions.SwaggerEndpoint("/swagger/v1/swagger.json", "Wtv API serving a very simple Post model");
