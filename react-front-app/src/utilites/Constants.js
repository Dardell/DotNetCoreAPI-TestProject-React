const API_BASE_URL_DEVELOPMENT = 'https://localhost:7230';
...
const production = {
    API_URL_GET_ALL_POSTS: `${API_BASE_URL_PROD}/${ENDPOINTS.GET_ALL_POSTS}`,
    API_URL_GET_POST_BY_ID: `${API_BASE_URL_PROD}/${ENDPOINTS.GET_POSTS_BY_ID}`,
    API_URL_CREATE_POST: `${API_BASE_URL_PROD}/${ENDPOINTS.CREATE_POST}`,
    API_URL_UPDATE_POST: `${API_BASE_URL_PROD}/${ENDPOINTS.UPDATE_POST}`,
    API_URL_DELETE_POST_BY_ID: `${API_BASE_URL_PROD}/${ENDPOINTS.DELETE_POST_BY_ID}`
};
